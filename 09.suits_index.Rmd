...
After both per capita metrics returned similar results (stored in commit from Sept 20th, 2022), I used the second definition which can be interpreted as a snapshot of how people are today. 
