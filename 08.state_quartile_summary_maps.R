...
#Saving map
ggsave(width = 11, height = 8, filename = "Exploratory_Output/PERC_Presentation_Maps/poc.jpeg")
...
state_choropleth(myMap_pov,
  ...
  ggtitle(label = "Difference between top and bottom LWCF spending quartiles in % rural") + 
  labs(fill = "Difference in % ")+
  theme(legend.position="bottom") + 
  theme(plot.title = element_text(size = 15))

#Saving map
ggsave(width = 11, height = 8, filename = "Exploratory_Output/PERC_Presentation_Maps/rural.jpeg")
...
state_choropleth(myMap_rural,
  ...
  # scale_fill_brewer(palette="Purples")+
  scale_fill_brewer(palette="PuOr")+
  ggtitle(label = "Difference between top and bottom LWCF spending quartiles in % people living below poverty line") + 
  labs(fill = "Difference in % ")+
  theme(legend.position="bottom")+ 
  theme(plot.title = element_text(size = 15))

#Saving map
ggsave(width = 11, height = 8, filename = "Exploratory_Output/PERC_Presentation_Maps/poverty.jpeg")
