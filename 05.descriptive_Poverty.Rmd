...
I then categorize counties into four quartiles based on the % of the population that is in poverty The first quartile categorizes the least imporvrished counties and the fourth quartile categorizes the counties with the most people under the poverty line. 
...
* In California, counties in the fourth quartile receive \$ -0.10 - \$ 0.01 less grant funding per person than counties in the first quartile. 
